...
class TestCapacityValidation(BasicTestSetup):
    ...
    def test_single_need_globally_overbooked_fails(self):
        ...
        jobs = [
            Job(self.unit1, self.phase1, self.adapter, self.date1, self.date2),
            Job(self.unit2, self.phase1, self.adapter, self.date1, self.date2),
        ]
    ...
    def test_multiple_need_locally_overbooked_fails(self):
        ...
        jobs = [
            Job(self.unit1, self.phase1, self.adapter, self.date1, self.date2),
            Job(self.unit2, self.phase1, self.adapter, self.date1, self.date2),
            Job(self.unit3, self.phase1, self.adapter, self.date1, self.date2),
        ]
        positions = [
    ...
    def test_multiple_needs_one_position_fails(self):
        ...
        jobs = [
            Job(self.unit1, self.phase1, self.adapter, self.date1, self.date2),
            Job(self.unit2, self.phase2, self.adapter, self.date1, self.date2),
            Job(self.unit3, self.phase4, self.adapter, self.date1, self.date2),
        ]
        positions = [
