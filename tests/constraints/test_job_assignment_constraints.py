...
class TestJobAssignmentConstraints(unittest.TestCase):
    def setUp(self):
        ...
        self.pos1 = Position(
            "Hangar A", [self.need1, self.need2, self.need3], capacity=1
        )
        self.pos2 = Position(
            "Hangar B", [self.need1, self.need2, self.need3], capacity=1
        )
        self.pos3 = Position(
            "Hangar C", [self.need1, self.need2, self.need3], capacity=1
        )
        self.pos4 = Position(
